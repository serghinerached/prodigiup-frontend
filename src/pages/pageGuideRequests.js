              ...
              <tr>
                <td style={{border:"1px solid black",textAlign:"left"}}>
                    ...
                    <svg width="600" height="300" >
                      ...
                      <line x1="353" y1="124" x2="353" y2="218" stroke="black" markerEnd="url(#arrow)" />
                      ...
                      <rect x="310" y="220" width="100" height="40" fill="lightgreen" stroke="black" />
                      <text x="360" y="245" textAnchor="middle" fill="black" style={{ cursor: "pointer" }} >ADD USER</text>
                      ...
                      <rect x="105" y="220" width="60" height="40" fill="red" stroke="black" />
                      <text x="135" y="245" textAnchor="middle" fill="white" style={{ cursor: "pointer" }} >Already</text>

                      <rect x="185" y="220" width="90" height="45" fill="cyan" stroke="black" />
                      <text x="230" y="240" textAnchor="middle" fill="black" style={{ cursor: "pointer" }} >Delete in<tspan x="230" dy="1em">myAccess</tspan></text>
                    
                      <line x1="240" y1="220" x2="265" y2="87" stroke="black" markerEnd="url(#arrow)" />

                      <line x1="220" y1="165" x2="220" y2="218" stroke="black" markerEnd="url(#arrow)" />
